...
```{r}
# #Able to run the chunk but unable to knit it. Zero-length calls cannot be mixed with non-xero calls. Execution halted
# #1. Choose two plot_types or two plot_ids and compare the mean rank shift (MRS) between them.
