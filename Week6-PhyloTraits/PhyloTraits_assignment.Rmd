...
```{r}
package.list <- c("ape", "seqinr","phylobase","adephylo","geiger","picante","stats","RColorBrewer","caper","phylom","pmc","ggplot2","tidyr","dplyr","phangorn","pander")
...
> ***Answer 2b***:  Between ~125 - 375 are regions apprporaite. Most alignment there 
...
par(mar=c(5,5,2,1)+0.1)
plot(seq.dist.K80, seq.dist.F80,pch = 20, col = "red", las = 1, asp = 1,xlim = c(0,0.7), ylim = c(0,0.7), xlab = "K20", ylab = "F80 Distance")
abline(b=1,a=0,lty=2)
text(0.65,0.6,"1:1")
...
```{r}
p.DNAbin.phyDat <- read.phyDat("./data/p.isolates.afa", format = "fasata", type = "DNA")
